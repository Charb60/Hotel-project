      ...
      <b-row class="text-left">
        <b-col cols="10" class="bg3">
          <center>
            ...
            <h5>เพิ่มรายการที่พักโรงแรม</h5></center>
          <hr />
          <form class="box3" v-on:submit.prevent="createHotel">
            ...
            <p><b><h5><strong> เลือกรูปภาพ </strong></h5></b></p>
            ...
            <p><b><h5><strong>รายละเอียดที่พัก </strong></h5></b></p>
            <p>
            ...
            <p><center>
            <b-button variant="success" type="submit"><i class="fa fa-check-square-o"> สร้างรายการ </i></b-button>
            <b-button variant="secondary" v-on:click="navigateTo('/hotels')"><i class="fa fa-arrow-circle-o-left">ย้อนกลับ</i> </b-button>
            </center></p>
          </form>
        </b-col>
      </b-row>
...
export default {
  ...
  methods: {
    async createHotel() {
      this.hotel.pictures = JSON.stringify(this.pictures); 
      try {
        await HotelService.post(this.hotel);
        this.$router.push({
          name: "hotels"
        });
      } catch (err) {
